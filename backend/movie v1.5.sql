...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Jun 2024 pada 15.52
...
(9, 'The Garfield Movie', 'Chris Pratt, Samuel L. jackson', 'https://www.garfield.movie/images/synopsis_poster.jpg', 'Garfield dan teman anjingnya, Odie, yang dipaksa keluar dari kehidupan nyaman mereka dan terlibat dalam pencurian berisiko tinggi yang diatur oleh Vic. Petualangan ini membawa mereka ke dalam serangkaian situasi lucu dan penuh aksi, yang akhirnya mempererat hubungan mereka dan menguji kesetiaan serta keberanian mereka.', 'Mark Dindal', 13, 127, 'https://www.youtube.com/watch?v=S3XjsSvwSuU&ab_channel=SonyPicturesEntertainment'),
(10, 'Despicable Me 4', 'Steve Carrel, Kristen  Wiig, Will Ferrel, Sofia Vergara', 'https://movies.universalpictures.com/media/dm4-poster-65c521e470ea3-1.jpg', 'dalam film ini, Gru (disuarakan oleh Steve Carell), bersama istrinya Lucy (disuarakan oleh Kristen Wiig) dan anak-anak mereka—Margo, Edith, dan Agnes—menyambut anggota baru keluarga, Gru Jr., yang suka mengganggu ayahnya. Gru harus menghadapi musuh baru, Maxime Le Mal (disuarakan oleh Will Ferrell) dan pacarnya Valentina (disuarakan oleh Sofia Vergara). Situasi memaksa keluarga Gru untuk melarikan diri, menjadikan film ini penuh dengan aksi dan humor', 'Chris Renaud, Patrick Delage', 13, 94, 'https://youtu.be/LtNYaH61dXY');
